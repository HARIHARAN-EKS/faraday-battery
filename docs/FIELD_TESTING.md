...
| F3 (LOW) | Raw ACPI object ids shown as identity: "Device name: BIF0_9", "Unique ID: ACMEBIF0_9" | ACPI-identifier heuristic demotes internal ids from the identity panel ("Not reported by this hardware"); raw values remain in the Advanced drawer (incl. a new `DeviceName (raw)` row); Unique ID moved to the drawer permanently |
